...
Usage:
    import torch
    model = torch.hub.load('ultralytics/yolov5模型', 'yolov5s')
"""
...
def _create(name, pretrained=True, channels=3, classes=80, autoshape=True, verbose=True, device=None):
    ...
    try:
        ...
        help_url = 'https://github.com/ultralytics/yolov5模型/issues/36'
...
if __name__ == '__main__':
    ...
    imgs = ['data/images/zidane.jpg',  # filename
            'https://github.com/ultralytics/yolov5模型/releases/download/v1.0/zidane.jpg',  # URI
